...
namespace WorldCitiesAPI.Data
{
    public class ApiResult<T>
    {
        ...
        /// </summary>
        /// <param name="source">An IQueryable source of generictype</param>
        ...
        /// <param name="filterColumn">The filtering columnname</param>
        ...
        )
        {
            ...
            {
                //Using the new System.Linq.Dynamic.Core library
